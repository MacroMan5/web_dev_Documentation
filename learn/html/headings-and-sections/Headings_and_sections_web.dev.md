...
**Source URL:** [https://web.dev/learn/html/headings-and-sections?continue=https%3A%2F%2Fweb.dev%2Flearn%2Fhtml%23article-https%3A%2F%2Fweb.dev%2Flearn%2Fhtml%2Fheadings-and-sections](https://web.dev/learn/html/headings-and-sections?continue=https%3A%2F%2Fweb.dev%2Flearn%2Fhtml%23article-https%3A%2F%2Fweb.dev%2Flearn%2Fhtml%2Fheadings-and-sections)  
**Last Updated:** 2025-05-23T01:02:21.141Z  
...
Now that you [understand markup semantics](https://web.dev/learn/html/semantic-html) and are aware of why choosing the right element is important, once you learn about all the different elements, you will generally pick the right element without much, if any, additional effort.
...
![The Accessibility Object Model in Chrome.](https://web.dev/static/learn/html/headings-and-sections/image/the-accessibility-object-918180193b513.png)
...
![A layout with a header, three columns, and a footer.](https://web.dev/static/learn/html/headings-and-sections/image/a-layout-a-header-three-31026f6b6c4b4.png)

A layout with a header, two sidebars, and a footer, is known as the [holy grail layout](https://web.dev/patterns/layout/holy-grail). There are many ways to mark up this content, including:
...
When a heading is nested in a document banner `<header>`, it is the heading for the application or site. When nested in `<main>`, whether or not it is nested within a `<header>` in `<main>`, it is the header for that page, not the whole site. When nested in an `<article>` or `<section>`, it is the header for that subsection of the page.
  ...
  CodePen Embed - nesting h1 in sections  
...
This is the outline for the visible content of the machine learning workshop site:
  ...
  CodePen Embed - Learn HTML: Outlining the <body>  
