...
Now that you have an understanding of [links](https://web.dev/learn/html/links) and lists, let's put the two together to create [navigation](https://web.dev/learn/html/navigation).
